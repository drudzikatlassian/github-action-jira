...
action "Jira Cloud Create Issue" {
  ...
  args = "--fields.project.key=INC --fields.issuetype.name=Incident --fields.summary=Build_completed_for_$GITHUB_REPOSITORY --fields.customfield_10021=10001 --fields.description=This_is_description"
}
